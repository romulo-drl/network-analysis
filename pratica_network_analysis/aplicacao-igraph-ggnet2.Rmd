...
primary_school <- read_csv('network-analysis-practice/igraph/primaryschool.csv') 

# Nodos e características sociodemográficas  
metadata <- read_csv("network-analysis-practice/igraph/metadata_primaryschool.csv")
...
Stucont_deg <- igraph::degree(Stucont,mode=c("All")) #Mode = Directionality
...
Stucont_eig <- igraph::evcent(Stucont)$vector #Gerando o eigenvector
...
```{r}
Stucont_bw<-igraph::betweenness(Stucont, directed = FALSE)
